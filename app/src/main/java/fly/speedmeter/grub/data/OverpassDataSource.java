...
import fly.speedmeter.grub.utils.LatLngHelper;

import static fly.speedmeter.grub.Constants.NODE_MAX_DISTANCE;
...
public class OverpassDataSource {
    ...
    private AbstractMap.SimpleEntry<OverpassQueryResult.Element, Float> getNearestWay(
        ...
        SortedMap<Float, OverpassQueryResult.Element> waySortedMap =
                getWaySortedMap(nodeSortedMap, latitude, longitude, Constants.WAY_MAX_COUNT);
